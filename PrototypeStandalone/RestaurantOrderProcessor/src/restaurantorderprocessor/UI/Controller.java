...
public class Controller {
    ...
    public boolean validateInput()
    {
        ...
        if (theModel.validateInput(theView.getCustomerDetails().getCustomerName(), CUSTOMER_NAME_REGEX))
            //Check Table Number against regex
            if (theModel.validateInput(theView.getCustomerDetails().getTableNumber(), TABLE_NUMBER_REGEX))
